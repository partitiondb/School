...
where dbid in (db_id('oxLearningGate'),db_id('oxLearningCommonDB'),db_id('oxLearningGlobal2014DB'),db_id('MobileDeveloper2014DB'),db_id('UXDeveloper2014DB'),db_id('oxLearningGlobal2015DB'),db_id('WebDeveloper2014DB'),db_id('MobileDeveloper2015DB'),db_id('UXDeveloper2015DB'),db_id('oxLearningGlobal2016DB'),db_id('WebDeveloper2015DB'),db_id('MobileDeveloper2016DB'),db_id('UXDeveloper2016DB'),db_id('WebDeveloper2016DB')) and cmd = 'AWAITING COMMAND' and spid <> @@spid;
exec(@sql);
end;
go
